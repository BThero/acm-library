...
- Если ищем минимум нужно добавлять линии по убыванию слоуп, а запросы для двух указателей по возрастанию x
- Если ищем максимум нужно добавлять линии по возрастанию слоуп, а запросы для двух указателей по возрастанию x
